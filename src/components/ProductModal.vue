        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-4">
              ...
              <!-- 延伸技巧，多圖 -->
              <div class="mt-5" v-if="tempProduct.image">
                <div v-for="(image, key) in tempProduct.image" class="mb-3 input-group" :key="key">
                  <input type="url" class="form-control form-control" placeholder="請輸入連結"
                    v-model="tempProduct.image[key]">
                  <button type="button" class="btn btn-outline-danger" @click="tempProduct.image.splice(key, 1)">
                    移除
                  </button>
                </div>
                <div v-if="tempProduct.image[tempProduct.image.length - 1] || !tempProduct.image.length
                  ">
                  <button class="btn btn-outline-primary btn-sm d-block w-100" @click="tempProduct.image.push('')">
                    新增圖片
                  </button>
                </div>
              </div>
            ...
            <div class="col-sm-8">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="請輸入標題" v-model="tempProduct.name">
              </div>
              ...
              <div class="row gx-2">
                <div class="mb-3 col-md-6">
                  ...
                  <!-- <input type="text" class="form-control" id="category" placeholder="請輸入分類"
                    v-model.number="tempProduct.category_id"> -->
                  <select class="form-control" id="categoryId" name="categoryId" v-model.number="tempProduct.category_id">
                    <option v-for="category in tempProduct.Category" :key="category.id" :value="category.id">{{
                      category.name }}
                    </option>
                  </select>
                </div>
                <div class="mb-3 col-md-6">
                  ...
                  <input type="text" class="form-control" id="quantity" placeholder="請輸入單位"
